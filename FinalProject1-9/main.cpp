...
ДОБАВИТЬ ОБРАБОТКУ ИСКЛЮЧЕНИЯ, когда пользователь вводит огромное число или команду без цифр user.cpp->getNewMessages(). - ГОТОВО
ДОБАВИТЬ ЗАПРЕТ НА РЕГИСТРАЦИЮ с уже имеющимся логином user.cpp->signUp(). - ГОТОВО
ДОБАВИТЬ ОБРАБОТКУ ИСКЛЮЧЕНИЯ, когда невозможно сохранить файл в user.cpp->signUp(). - ГОТОВО
ДОБАВИТЬ ОБРАБОТКУ ИСКЛЮЧЕНИЯ, когда невозможно отправить сообщение user.cpp->sendMessage(). - ГОТОВО
